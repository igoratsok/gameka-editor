...
public:
     ...
     */
    void openNewProject(std::string nomeJogo, std::string nomePasta, int preProjectId);
    /**
...
private:
     ...
     */
    void createGameDataInstance(int preProjectId, std::string gameName, std::string folderName, GameData *gameData);
